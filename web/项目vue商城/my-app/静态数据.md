...
pinia 官网：https://pinia.vuejs.org/zh/core-concepts/
...
components 下的 CommonHeader.vue
...
2.在 views 下创建 Home.vue

3.在 Main.vue 中放置路由出口
...
在 api 文件夹下创建 mockData 文件夹，在其中创建 home.js
...
echarts 官网https://echarts.apache.org/handbook/zh/get-started/
...
!!!如果在展示图表后，控制台报了下面这个警告（**页面中的 echarts 图表缩放后在控制台就会出现以下提醒**）

# 用户管理

1.创建路由

在 router.js 下的 index.js 中
...
在 views 下创建 Mall.vue,Page1.vue,Page2.vue

```js

```

在 mockData 下创建 permission.js
