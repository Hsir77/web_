						...
						if (
							...
							(this.internal =
								...
								r(
									n,
									y,
									'function(c,p,s){p=' + m + ';' + m + "='';c();s=" + m + ';' + m + '=p+s;return s}',
								),
								r(
									n,
									d,
		...
		function (e, t, n) {
			...
			var o = function (e, t) {
				for (
					...
					for (
						var a = t[s], u = a.test.ignoreCase ? 'ig' : 'g', c = new RegExp(a.test.source, u), l = 0;
						l < o.length;
						l++
					) {
						var f = o[l],
						...
						if ('string' === f.type) {
							for (var h = void 0, d = 0, m = [], v = f.value; null !== (h = c.exec(v)); )
								h.index > d && ((p = new i('string', v.slice(d, h.index), p)), m.push(p)),
			...
			var r = Object.prototype.toString,
				...
				o = function s(e, t) {
					var n = void 0,
						r = i(e);
					if (
						('Object' === r ? (n = Object.create(t || {})) : 'Array' === r && (n = [].concat(t || [])), n)
					) {
			...
			var r = {
					...
					switch (('#' === t && h('#value', '@value'), p)) {
						...
						case 'each':
							(l = r._split(a)),
								l.shift(),
								'as' === l[1] &&
									(h('each object as value index', 'each object value index'), l.splice(1, 1));
							i =
								'$each(' +
								(l[0] || '$data') +
								',function(' +
				...
				_split: function (e) {
					...
					for (var t = 0, n = e.shift(), r = /\]|\)/, i = [[n]]; t < e.length; ) {
						var o = e[t];
						'punctuator' === o.type || ('punctuator' === n.type && !r.test(n.value))
							? i[i.length - 1].push(o)
							: i.push([o]),
							(n = o),
							t++;
